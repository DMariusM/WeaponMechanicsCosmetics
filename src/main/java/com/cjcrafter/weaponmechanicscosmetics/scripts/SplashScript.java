...
public class SplashScript extends ProjectileScript<WeaponProjectile> {
    ...
    public SplashScript(@NotNull Plugin owner, @NotNull WeaponProjectile projectile) {
        ...
        mechanics = config.getObject(projectile.getWeaponTitle() + ".Cosmetics.Splash_Mechanics", MechanicManager.class);
        wasInWater = isInWater();
    }

    public SplashScript(@NotNull Plugin owner, @NotNull WeaponProjectile projectile, @NotNull MechanicManager mechanics) {
        super(owner, projectile);
