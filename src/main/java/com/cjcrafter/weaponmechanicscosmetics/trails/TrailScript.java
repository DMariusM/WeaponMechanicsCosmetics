...
import com.cjcrafter.weaponmechanicscosmetics.trails.shape.Vec2;
...
public class TrailScript extends ProjectileScript<AProjectile> {
    ...
    public TrailScript(@NotNull Plugin owner, @NotNull WeaponProjectile projectile) {
        ...
        this.trail = WeaponMechanics.getInstance().getWeaponConfigurations().getObject(projectile.getWeaponTitle() + ".Trail", Trail.class);
